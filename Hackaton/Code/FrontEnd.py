...
def ventana():
    ...
    def chatbot_response(msg):
        import json
        with open('intentss.json') as file:
            data = json.load(file)
...
nombre_lab = Label(log_in, compound=CENTER, text=texto1, image=image, padx=100, pady=70, takefocus=True)
...
# ______________ DISCORD ______________

# _______________ Telegram ____________


# _________ INICIO ___________